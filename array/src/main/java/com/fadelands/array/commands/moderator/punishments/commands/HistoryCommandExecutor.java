...
import com.fadelands.array.commands.moderator.punishments.*;
import com.fadelands.array.commands.moderator.punishments.tokens.PunishClientToken;
import com.fadelands.array.players.FadeLandsUser;
...
public class HistoryCommandExecutor implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] args) {
       ...
       if(args.length == 0){
        ...
        FadeLandsUser fadeLandsPlayer = new FadeLandsUser();
