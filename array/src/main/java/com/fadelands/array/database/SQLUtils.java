...
public class SQLUtils {
    ...
    public static void updateTable(String playerName, String table, String columnName, String value) {
        try (Connection connection = Array.getConnection()) {
    ...
    public static void updateTable(String playerName, String table, String columnName, Boolean value) {
        try (Connection connection = Array.getConnection()) {
            String query = "UPDATE " + table + " SET " + columnName + "=? WHERE player_uuid='" + new User().getUuid(playerName) + "'";
            try (PreparedStatement p = connection.prepareStatement(query)) {
    ...
    public static void updateTable(String playerName, String table, String columnName, Integer value) {
        try (Connection connection = Array.getConnection()) {
            String query = "UPDATE " + table + " SET " + columnName + "=? WHERE player_uuid='" + new User().getUuid(playerName) + "'";
            try (PreparedStatement p = connection.prepareStatement(query)) {
    ...
    public static void updateTable(String playerName, String table, String columnName, Timestamp value) {
        try (Connection connection = Array.getConnection()) {
            String query = "UPDATE " + table + " SET " + columnName + "=? WHERE player_uuid='" + new User().getUuid(playerName) + "'";
            try (PreparedStatement p = connection.prepareStatement(query)) {
