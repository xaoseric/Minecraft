...
public class PunishmentHandler {
    ...
    public void punish(String appealKey, UUID punisherUuid, PunishmentType punishType, String reason, UUID punishedUuid, long date, long until) {
    ...
    public void removePunishment(String appealKey, String removalReason, String remover) {
